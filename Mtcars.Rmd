...
dwtest(mod)
```
### Até aqui parece que chegamos no melhor ajuste, e não foram necessárias transformações para melhorar o ajuste. E até aqui, todos os pressupostos foram atendidos utilizando os testes formais.
